...
## INPUTS
    ...
    s_w= src+"FEATURES/FEAT_DATA_"+str(fold)+"_ahi_2Out/"
    seg_l="ahi"
    ...
    for current_sens in sens:
        ...
        model_name = src_o+"LGB_OUT_"+ seg_l+"_"+str(sen_names)+"_m.txt"
        if not (os.path.exists( model_name )):
            ...
            np.savetxt(src_o+"LGBMCOEF_f_"+ seg_l+"_"+str(sen_names)+'_m.txt', relevance, fmt='%f', delimiter='\n') 
            ...
            # # save model
            joblib.dump(model, src_o+"LGBD_MODEL_f"+ seg_l+"_"+str(sen_names)+'_m.pkl')
