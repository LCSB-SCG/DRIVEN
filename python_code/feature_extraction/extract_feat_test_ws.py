...
if __name__ == '__main__':
    ...
    ## VALIDATION
    if layer_3:
        s_w= "PREDICTIONS/FEATURES/VAL/"+st+"s/FEAT_DATA_"+str(fold)+"_ahi/"
    else:
        s_w= "PREDICTIONS/FEATURES/VAL/"+st+"s/FEAT_DATA_"+str(fold)+"_ahi_2Out/"
    ...
    # ## TEST
    if layer_3:
        s_w= "PREDICTIONS/FEATURES/TEST/"+st+"s/FEAT_DATA_"+str(fold)+"_ahi/"
    else:
        s_w= "PREDICTIONS/FEATURES/TEST/"+st+"s/FEAT_DATA_"+str(fold)+"_ahi_2Out/"
