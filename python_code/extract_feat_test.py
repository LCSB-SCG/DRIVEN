...
if __name__ == '__main__':
    ...
    src_data=src+"DATA_5s/"


    src_w_old=src+"WEIGHTS_2out_ahi_"+str(fold)+"/"
    src_w = src+"WEIGHTS_2out_ahi_"+str(fold)+"_all/"
    ...
    ## VALIDATION
    if layer_3:
        s_w= "PREDICTIONS/VAL/FEAT_DATA_"+str(fold)+"_ahi/"
    else:
        s_w= "PREDICTIONS/VAL/FEAT_DATA_"+str(fold)+"_ahi_2Out/"
    ...
    # ## TEST
    if layer_3:
        s_w= "PREDICTIONS/TEST/FEAT_DATA_"+str(fold)+"_ahi/"
    else:
        s_w= "PREDICTIONS/TEST/FEAT_DATA_"+str(fold)+"_ahi_2Out/"
